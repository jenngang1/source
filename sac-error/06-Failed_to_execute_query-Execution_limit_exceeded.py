...
OR  "The parallel execution limit per tenant has been exceeded:"
...
| search ErrorCategory="Failed to execute query-Execution limit exceeded"
...
| rex field=err_detail "^(?<err_class>.*?)\: (?<err_category>.*)$$"
...
| stats count by errorClass errorCategory 
